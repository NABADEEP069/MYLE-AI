...
const buttonRef = useRef<HTMLButtonElement>(null);
  ...
  return (
    <main className="flex flex-col items-center min-h-screen p-8 lg:p-20">
      ...
      <h1 className="text-4xl font-semibold text-blue-800 text-center mb-2">AI Diagnostic Assistant </h1>
      <p className="text-center mb-8 text-lg text-gray-600">
        Enter your symptoms below. This tool is for informational purposes only.
        <strong className="block mt-2">Always consult a healthcare professional for medical advice.</strong>
      </p>
            ...
            <div className="p-6 bg-gray-50 border border-gray-300 rounded-lg">
              {result.critical_warning ? (
                <div className="bg-red-50 border border-red-500 text-red-600 p-4 rounded-lg">
                  ...
                  <p className="mt-2"><strong>Please seek immediate medical attention.</strong></p>
                </div>
              ) : (
                <>
                  <h2 className="text-2xl text-blue-600 border-b-2 border-blue-600 pb-2 mb-6">Analysis Result</h2>
                  ...
                  {result.primary_treatment && (
                    <div className="mb-6">
                      <h3 className="text-xl font-semibold mb-2 text-gray-700">Primary Treatment for {result.primary_treatment.disease}</h3>
                    ...
                    <div className="mt-4">
                      ...
                      <ul className="list-disc pl-6">
                        {result.references.map((ref, idx) => (
                          <li key={idx}><a href={ref.url} target="_blank" rel="noopener noreferrer" className="text-blue-700 underline">{ref.title}</a></li>
                        ))}
                      </ul>
                    </div>
                  )}
